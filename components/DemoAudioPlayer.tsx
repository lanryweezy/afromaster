...
const DemoAudioPlayer: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const dataUriToArrayBuffer = (dataUri: string): ArrayBuffer => {
            ...
            // Fix: sanitize base64 string to handle potential URL-safe characters or whitespaces
            const safeBase64 = base64.replace(/-/g, '+').replace(/_/g, '/').replace(/\s/g, '');
            
            const byteString = atob(safeBase64);
