...
// Lazy initialization helper for the Gemini API client.
// This ensures the client is instantiated only when needed, avoiding crashes
// if the API key is missing during app startup.
